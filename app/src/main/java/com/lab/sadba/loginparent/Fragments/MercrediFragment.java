...
public class MercrediFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        recycler_mercredi =  view.findViewById(R.id.recycler_temps);
        ...
        if (isNetworkAvailable(getActivity())){
            api.getTemps("MA1445001","mercredi")
    ...
    private List<Temps> getDBTemps(){
        return realm.copyFromRealm(realm.where(Temps.class).equalTo("num_jour", "3").findAll());
